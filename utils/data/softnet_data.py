...
class SoftNetDataset(GraspDatasetBase):
    ...
    def __init__(self, file_path, start=0.0, end=1.0, ds_rotate=0, **kwargs):
        ...
        stiffnessf = [f.replace('pos.txt', 's.png') for f in graspf]
        depthf = [f.replace('s.png', 'd.png') for f in stiffnessf]
